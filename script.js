...
function displayCurrentTime(){
    ...
    // --Check if the current time is in alarm if yes then alert user
...
// Set Alarms| Take input from user in hour minutes ---//
...
function createNewAlarmDOM(){
    ...
    alarmItem.classList.add('alarm-items');
        ...
        logo.setAttribute('src', './images/retro-alarm-clock.png');
        ...
        delButton.setAttribute('src', './images/deletes.png');
